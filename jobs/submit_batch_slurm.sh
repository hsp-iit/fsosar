...
reservation_name="sberti_14"  # sberti_14 Set to "" to disable reservation usage
...
datasets=("SSv2" "NTURGBD120" "Diving48")

# Define OS losses to test (can be customized)
os_losses=("discriminator")
...
echo
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
    echo "Aborted. No jobs were submitted."
    exit 0
fi
